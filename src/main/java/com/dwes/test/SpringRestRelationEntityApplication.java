...
import com.dwes.test.entities.Gender;
import com.dwes.test.entities.User;
import com.dwes.test.entities.UserProfile;
import com.dwes.test.repository.UserProfileRepository;
import com.dwes.test.repository.UserRepository;

@SpringBootApplication
public class SpringRestRelationEntityApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringRestRelationEntityApplication.class, args);
	}
